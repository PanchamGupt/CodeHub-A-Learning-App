...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["cources-cources-module"], {
  ...
  function srcAppCourcesCourcesPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(CourcesPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.router.queryParams.subscribe(function (res) {
            ...
            console.log(JSON.parse(_this.getValue));
          });
        }
      }, {
        key: "loadContent",
        value: function loadContent(courses) {
          console.log(courses);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], CourcesPage);
    /***/
  }
}]);
