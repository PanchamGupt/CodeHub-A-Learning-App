...
let RegisterPage = class RegisterPage {
    constructor(location, formBuilder, router, afAuth, alert) {
            ...
            try {
                this.afAuth.auth.createUserWithEmailAndPassword(this.registeredData.value.email, this.registeredData.value.password).then((res) => {
                    ...
                    this.afAuth.auth.currentUser.sendEmailVerification().then(() => {
                        this.alertAll("Varify Email", "Visit your email for varify your email");
                    });
                });
            }
            catch (error) {
    ...
    alertAll(header, message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.allet = yield this.alert.create({
                header: header,
                message: message,
                buttons: ['Ok']
            });
...
RegisterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
        _angular_fire_auth__WEBPACK_IMPORTED_MODULE_5__["AngularFireAuth"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["AlertController"]])
], RegisterPage);
