...
let LoginPage = class LoginPage {
    constructor(storage, location, formBuilder, router, afAuth, alert) {
        ...
        this.errorMessages = {
            ...
            password: [
                ...
                { 'type': "minlength", 'message': "Please enter a valid password" }
            ]
        };
    ...
    loginData() {
        ...
        try {
            ...
            if (this.afAuth.auth.currentUser.emailVerified) {
                this.storage.set('currentUser', this.userLogin.value).then(val => {
                });
