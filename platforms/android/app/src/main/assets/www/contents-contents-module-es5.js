      ...
      _createClass(ContentsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.queryParams.subscribe(function (params) {
            _this.language = params.type;
          });

          switch (this.language) {
            case "C Programming":
              {
                fetch('../../assets/data/cdata.json').then(function (res) {
                  return res.json();
                }).then(function (json) {
                  _this.data = json;
                });
            ...
            case "C++ Programming":
              {
                fetch('../../assets/data/c++data.json').then(function (res) {
                  return res.json();
                }).then(function (json) {
                  _this.data = json;
                });
            ...
            case "Java Programming":
              {
                fetch('../../assets/data/javadata.json').then(function (res) {
                  return res.json();
                }).then(function (json) {
                  _this.data = json;
                });
            ...
            case "Python Programming":
              {
                //  fetch('../../assets/data/pythondata.json').then(res=>res.json()).then(json=>{this.data=json})
                this.fds.getPythonData().subscribe(function (data) {
                  _this.data = data;
                }, function (error) {
                  console.log(error);
          ...
          console.log(this.data); // console.log(this.len)
        }
      }, {
        key: "details",
        value: function details(c) {
          // this.navCtrl.navigateForward(['/details'], true, this.navigationExtras);
          // this.navCtrl.push('DetailPage', {data: c});
